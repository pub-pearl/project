...
var ClientToolJS = (function() {
    ...
    var contentCtgs = [
        {ctg:'actor'    ,empty:'번호', grpCode:'KORAIL_2'},
        {ctg:'mask'     ,empty:'마스크착용', grpCode:'KORAIL_3'},
        {ctg:'category' , grpCode:'KORAIL_1'}
    ];
    // var metaCtgs = {
    //     '1' : {ctg:'type', empty:'이상행동'}
    // };
    var category = [];
    var metaCategory = {};
