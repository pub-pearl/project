...
var imageInspectorScript = (function() {
    ...
    function renderJobContents(data) {
        ...
        // 임시저장, 수정하기, 완료
        gnbInspectorViewScript.setProcess(data.jobInfo);
    ...
    function refreshData() {
        colorTicket = 0;
        resetEventHandler();
        // gnbInspectorViewScript.loadJobHistory(getContext, failCallback);
    ...
    function getAnnotationData() {
        $Object.selectWorkData(function(data) {
            ...
            $("input[name=temperature]").attr("disabled", true);
